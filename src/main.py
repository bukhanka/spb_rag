...
class MultiModalRetriever:
    def __init__(self, data_processor: SPBDataProcessor):
        ...
        self.bm25_contacts = self._create_bm25_index(
    ...
    def _create_vectorstore(self):
        ...
        return Chroma.from_documents(
            ...
            persist_directory="/home/dukhanin/sber_hack/yazzh_ai/chroma_db/contacts"
        )

    def _create_bm25_index(self, documents):
...
class SPBCityAssistant:
    def __init__(self):
        self.data_processor = SPBDataProcessor("/home/dukhanin/sber_hack/yazzh_ai/data")
